...
public class InvoiceTests {
	...
	public void testInvoice01() {
		...
		Person person = new Person(UUID.fromString("11111111-2222-3333-4444-555555555555"), "Barron", "Vaughn", "911", new ArrayList<>());
		Company company = new Company(UUID.fromString("66666666-7777-8888-9999-000000000000"), person, "Barron's Silly Funny Financial News", address);
		Invoice invoice = new Invoice(UUID.fromString("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"), company, person, LocalDate.now(), new ArrayList<>());
		...
		Person consultant = new Person(UUID.fromString("3c82635d-d7f2-4f89-8b2e-8df0e9821ae0"), "Lewis", "Rokke", "555-0200", new ArrayList<>());
	...
	public void testInvoice02() {
		...
		License smOffice = new License(UUID.fromString("b4f02d75-d29b-468d-a244-1a1e3d5d92a6"), "SM Office", 25.99, 1212.12);
